...
class TurnLeftCommandTest extends TestCase
{
    ...
    public function testExecute(array $initialPosition, array $expectedPosition)
    {
        ...
        $instruction = InstructionModelGenerator::generate(['movement' => InstructionMovement::LEFT]);

        $turnLeftCommand = new TurnLeftCommand($instruction->getInstructionMovement(), $electricVehicle);
